...
np.ma.dump(geopt_bias_eramean, path_salida + '/biasMean_geopt_'+ YY + MM + DD + HH + periodo +'_ana'  + ANA )
np.ma.dump(u_bias_eramean, path_salida +  '/biasMean_u_'  + YY + MM + DD + HH + periodo +'_ana'  + ANA )
np.ma.dump(v_bias_eramean, path_salida +  '/biasMean_v_'  + YY + MM + DD + HH + periodo +'_ana'  + ANA )
np.ma.dump(tk_bias_eramean, path_salida +  '/biasMean_tk_' + YY + MM + DD + HH + periodo +'_ana'  + ANA )
np.ma.dump(q_bias_eramean, path_salida + '/biasMean_q_' + YY + MM + DD + HH + periodo +'_ana'  + ANA )
np.ma.dump(psfc_bias_eramean, path_salida + '/biasMean_psfc_'  + YY + MM + DD + HH + periodo +'_ana'  + ANA )
