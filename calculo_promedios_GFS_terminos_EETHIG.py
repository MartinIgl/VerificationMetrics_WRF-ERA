...
if EXP == 'GFS':
	...
	path_out = '/data/miglesias/verificacion_doc/dif_ERA_GEFS/ErrorEnergiaTotalHumeda' + exp + '/meanterm'
else:
	quit()
...
while d <= diafin:
	...
	cinetica = np.ma.load( path_in + '/cinetica_GFS_' + YY + MM + DD + HH + FCST)
	temp = np.ma.load( path_in  + '/temp_GFS_' + YY + MM + DD + HH + FCST)
	humedad = np.ma.load( path_in  + '/humedad_GFS_' + YY + MM + DD + HH + FCST)
	psup = np.ma.load( path_in + '/psup_GFS_' + YY + MM + DD + HH + FCST)
...
#np.ma.dump(M_cin_T_recortado, path_out + '/meanterm' + '/M_cinetica_temporal_recortado' + FCST)
#np.ma.dump(M_cin_H_recortado, path_out + '/meanterm' + '/M_cinetica_horizontal_recortado' + FCST)
#np.ma.dump(M_cin_V_recortado, path_out + '/meanterm' + '/M_cinetica_vertical_recortado' + FCST)
#
...
#np.ma.dump(M_tem_T_recortado, path_out + '/meanterm' + '/M_temp_temporal_recortado' + FCST)
#np.ma.dump(M_tem_H_recortado, path_out + '/meanterm' + '/M_temp_horizontal_recortado' + FCST)
#np.ma.dump(M_tem_V_recortado, path_out + '/meanterm' + '/M_temp_vertical_recortado' + FCST)
#
...
#np.ma.dump(M_hum_T_recortado, path_out + '/meanterm' + '/M_humedad_temporal_recortado'+ FCST)
#np.ma.dump(M_hum_H_recortado, path_out + '/meanterm' + '/M_humedad_horizontal_recortado '+ FCST)
#np.ma.dump(M_hum_V_recortado, path_out + '/meanterm' + '/M_humedad_vertical_recortado'+ FCST)
#
...
#np.ma.dump(M_p_T_recortado, path_out + '/meanterm' + '/M_psup_temporal_recortado' + FCST)
#np.ma.dump(M_p_H_recortado, path_out + '/meanterm' + '/M_psup_horizontal_recortado' + FCST)
#np.ma.dump(M_p_V_recortado, path_out + '/meanterm' + '/M_psup_vertical_recortado' + FCST)
...
np.ma.dump(M_cin_T, path_out + '/M_cinetica_temporal_'+periodo + FCST)
np.ma.dump(M_cin_H, path_out + '/M_cinetica_horizontal_'+periodo + FCST)
np.ma.dump(M_cin_V, path_out + '/M_cinetica_vertical_'+periodo + FCST)
#
M_tem_T = M_EETH_temporal(totaltemp1)
M_tem_H = M_EETH_horizontal(totaltemp1)
M_tem_V = M_EETH_vertical(totaltemp1)

np.ma.dump(M_tem_T, path_out + '/M_temp_temporal_'+periodo + FCST)
np.ma.dump(M_tem_H, path_out + '/M_temp_horizontal_'+periodo + FCST)
np.ma.dump(M_tem_V, path_out + '/M_temp_vertical_'+periodo + FCST)
...
np.ma.dump(M_hum_T, path_out + '/M_humedad_temporal_'+periodo + FCST)
np.ma.dump(M_hum_H, path_out + '/M_humedad_horizontal_'+periodo + FCST)
np.ma.dump(M_hum_V, path_out + '/M_humedad_vertical_'+periodo + FCST)

#
M_p_T = M_EETH_temporal(totalpsup1)
M_p_H = M_EETH_horizontal(totalpsup1)
M_p_V = M_EETH_vertical(totalpsup1)
np.ma.dump(M_p_T, path_out + '/M_psup_temporal_'+periodo + FCST)
np.ma.dump(M_p_H, path_out + '/M_psup_horizontal_'+periodo + FCST)
np.ma.dump(M_p_V, path_out + '/M_psup_vertical_'+periodo + FCST)
