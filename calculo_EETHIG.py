...
#	me devuelve todo esto y puedo llamarlo por separado despues
	...
	np.ma.dump(cinetica, path_out + '/' + M[m] + '/cinetica_'+ YY + MM + DD + HH + FCST)
	np.ma.dump(temp, path_out + '/' + M[m] + '/temp_'+ YY + MM + DD + HH + FCST)
	np.ma.dump(psup, path_out + '/' + M[m] + '/psup_'+ YY + MM + DD + HH + FCST)
	np.ma.dump(humedad, path_out + '/' + M[m] + '/humedad_'+ YY + MM + DD + HH + FCST)
	np.ma.dump(EETH, path_out + '/' + M[m] + '/EETH_'+ YY + MM + DD + HH +  FCST)
