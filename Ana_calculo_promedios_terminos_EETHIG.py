...
if EXP == 'connud':
	exp = '/connud'
	path_in = '/data/miglesias/verificacion_doc/dif_ERA_WRFupp/ErrorEnergiaTotalHumeda'  + exp
...
#dominio grafico
	...
	while d <= diafin:
		...
		cinetica = np.ma.load( path_in +'/' + M[m] + '/cinetica_' + YY + MM + DD + HH + '_ana' + ANA )
		temp = np.ma.load( path_in +'/' + M[m] + '/temp_' + YY + MM + DD + HH + '_ana' + ANA )
		humedad = np.ma.load( path_in +'/' + M[m] + '/humedad_' + YY + MM + DD + HH + '_ana' + ANA )
		psup = np.ma.load( path_in +'/' + M[m] + '/psup_' + YY + MM + DD + HH + '_ana' + ANA )
...
#dominio grafico
	...
	#np.ma.dump(M_cin_T_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_cinetica_temporal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_cin_H_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_cinetica_horizontal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_cin_V_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_cinetica_vertical_recortado' + '_ana' + ANA )
	...
	#np.ma.dump(M_tem_T_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_temp_temporal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_tem_H_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_temp_horizontal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_tem_V_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_temp_vertical_recortado' + '_ana' + ANA )
	...
	#np.ma.dump(M_hum_T_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_humedad_temporal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_hum_H_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_humedad_horizontal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_hum_V_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_humedad_vertical_recortado' + '_ana' + ANA )
	...
	#np.ma.dump(M_p_T_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_psup_temporal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_p_H_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_psup_horizontal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_p_V_recortado, path_out + '/meanterm' + '/' + M[m] + '/M_psup_vertical_recortado' + '_ana' + ANA )
	...
	np.ma.dump(M_cin_T, path_out + '/meanterm' + '/' + M[m] + '/M_cinetica_temporal' +periodo+'_ana' + ANA )
	np.ma.dump(M_cin_H, path_out + '/meanterm' + '/' + M[m] + '/M_cinetica_horizontal' +periodo+'_ana' +ANA )
	np.ma.dump(M_cin_V, path_out + '/meanterm' + '/' + M[m] + '/M_cinetica_vertical' +periodo+'_ana' + ANA )
	...
	np.ma.dump(M_tem_T, path_out + '/meanterm' + '/' + M[m] + '/M_temp_temporal' +periodo+'_ana' + ANA )
	np.ma.dump(M_tem_H, path_out + '/meanterm' + '/' + M[m] + '/M_temp_horizontal' +periodo+'_ana' + ANA )
	np.ma.dump(M_tem_V, path_out + '/meanterm' + '/' + M[m] + '/M_temp_vertical' +periodo+'_ana' + ANA )
	...
	np.ma.dump(M_hum_T, path_out + '/meanterm' + '/' + M[m] + '/M_humedad_temporal' +periodo+'_ana' + ANA )
	np.ma.dump(M_hum_H, path_out + '/meanterm' + '/' + M[m] + '/M_humedad_horizontal' +periodo+'_ana' + ANA )
	np.ma.dump(M_hum_V, path_out + '/meanterm' + '/' + M[m] + '/M_humedad_vertical' +periodo+'_ana' + ANA )
	...
	np.ma.dump(M_p_T, path_out + '/meanterm' + '/' + M[m] + '/M_psup_temporal' +periodo+'_ana' + ANA )
	np.ma.dump(M_p_H, path_out + '/meanterm' + '/' + M[m] + '/M_psup_horizontal' +periodo+'_ana' + ANA )
	np.ma.dump(M_p_V, path_out + '/meanterm' + '/' + M[m] + '/M_psup_vertical' +periodo+'_ana' + ANA )
