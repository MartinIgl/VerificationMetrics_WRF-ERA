...
#dominio de grafico
	...
	while day <= dayfin:
		...
		eeth = np.ma.load( path_in +'/' + M[m] +'/CE_EETH_' + YY + MM + DD + HH )
	...
	#dominio entero
	np.ma.dump(M_EETH_T, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_temporal_Casodeestudio_19-23')
	np.ma.dump(M_EETH_H, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_horizontal_Casodeestudio_19-23')
	np.ma.dump(M_EETH_V, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_vertical_Casodeestudio_19-23')
