...
while m < len(MEM):	# m < 20
	...
	if exp=='/GFS':
		# ------Geopotencial------	
		geopt_difMEM = np.ma.load(path_in + '/dif_geoptMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )	
		geopt_difMEM2[:,:,:,m]= geopt_difMEM*geopt_difMEM
		# ------Temperatura------
		tk_difMEM= np.ma.load(path_in + '/dif_tkMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )

		tk_difMEM2[:,:,:,m]= tk_difMEM*tk_difMEM
		# ------Humedad especifica------
		q_difMEM= np.ma.load(path_in + '/dif_qMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )

		q_difMEM2[:,:,:,m]= q_difMEM*q_difMEM
		# ------Viento: componentes U y V------
		u_difMEM= np.ma.load(path_in + '/dif_uMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )

	 	u_difMEM2[:,:,:,m]= u_difMEM*u_difMEM

		v_difMEM= np.ma.load(path_in + '/dif_vMEM-mean_'+ YY + MM + DD + HH +periodo+ FCST )

		v_difMEM2[:,:,:,m]= v_difMEM*v_difMEM
		# ------PSFC------
		psfc_difMEM= np.ma.load(path_in + '/dif_psfcMEM-mean_'+ YY + MM + DD + HH +periodo+ FCST )

		psfc_difMEM2[:,:,m]= psfc_difMEM*psfc_difMEM

	else:
		# ------Geopotencial------	
		geopt_difMEM = np.ma.load(path_in + '/' + MEM[m] + '/dif_geoptMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )	
	
		geopt_difMEM2[:,:,:,m]= geopt_difMEM*geopt_difMEM
		# ------Temperatura------
		tk_difMEM= np.ma.load(path_in + '/' + MEM[m] + '/dif_tkMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )

		tk_difMEM2[:,:,:,m]= tk_difMEM*tk_difMEM
		# ------Humedad especifica------
		q_difMEM= np.ma.load(path_in + '/' + MEM[m] + '/dif_qMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )

		q_difMEM2[:,:,:,m]= q_difMEM*q_difMEM
		# ------Viento: componentes U y V------
		u_difMEM= np.ma.load(path_in + '/' + MEM[m] + '/dif_uMEM-mean_' + YY + MM + DD + HH +periodo+ FCST )

	 	u_difMEM2[:,:,:,m]= u_difMEM*u_difMEM

		v_difMEM= np.ma.load(path_in + '/' + MEM[m] + '/dif_vMEM-mean_'+ YY + MM + DD + HH +periodo+ FCST )

		v_difMEM2[:,:,:,m]= v_difMEM*v_difMEM
		# ------PSFC------
		psfc_difMEM= np.ma.load(path_in + '/' + MEM[m] + '/dif_psfcMEM-mean_'+ YY + MM + DD + HH +periodo+ FCST )
...
np.ma.dump(geopt_spread, path_salida  + '/geopt_spread_' + YY + MM + DD + HH +periodo+ FCST )
np.ma.dump(tk_spread, path_salida  + '/tk_spread_' + YY + MM + DD + HH +periodo+ FCST )
np.ma.dump(q_spread, path_salida  + '/q_spread_' + YY + MM + DD + HH +periodo+ FCST )
np.ma.dump(u_spread, path_salida  + '/u_spread_' + YY + MM + DD + HH +periodo+ FCST)
np.ma.dump(v_spread, path_salida + '/v_spread_' + YY + MM + DD + HH +periodo+ FCST )
np.ma.dump(psfc_spread, path_salida  + '/psfc_spread_' + YY + MM + DD + HH +periodo+ FCST )
