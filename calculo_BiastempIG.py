...
while m < len(M):
	...
	if exp == '/GEFS':
		...
		np.ma.dump(bias_u, path_out + '/' + M[m] + '/bias_u_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_v, path_out + '/' + M[m] + '/bias_v_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_t, path_out + '/' + M[m] + '/bias_t_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_q, path_out + '/' + M[m] + '/bias_q_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		...
		np.ma.dump(bias_u, path_out + '/bias_u_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_v, path_out + '/bias_v_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_t, path_out + '/bias_t_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_q, path_out + '/bias_q_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
...
#promedio total vertical yhorizontal cada delta t
	...
	if exp == '/GEFS':
		...
		np.ma.dump(bias_utot, path_out + '/' + M[m] + '/bias_utot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_vtot, path_out + '/' + M[m] + '/bias_vtot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_ttot, path_out + '/' + M[m] + '/bias_ttot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_qtot, path_out + '/' + M[m] + '/bias_qtot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		...
		np.ma.dump(bias_utot, path_out + '/bias_utot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_vtot, path_out + '/bias_vtot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_ttot, path_out + '/bias_ttot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_qtot, path_out + '/bias_qtot_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
...
#promedio total vertical y temporal para cada delta t
	...
	if exp == '/GEFS':
		...
		np.ma.dump(bias_uH, path_out + '/' + M[m] + '/bias_uH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_vH, path_out + '/' + M[m] + '/bias_vH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_tH, path_out + '/' + M[m] + '/bias_tH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_qH, path_out + '/' + M[m] + '/bias_qH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		...
		np.ma.dump(bias_uH, path_out + '/bias_uH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_vH, path_out + '/bias_vH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_tH, path_out + '/bias_tH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
		np.ma.dump(bias_qH, path_out + '/bias_qH_'  + date + '_M'+ M[m] +periodo+ '_recortado'+FCST)
