...
while m < len(M):
	...
	if exp=='/GFS':
		rmsd_geo = np.ma.load( path_in + 'rmsd_geo_' + temp + '_M'+ M[m]+periodo+ FCST )
		rmsd_u = np.ma.load( path_in + 'rmsd_u_' + temp + '_M'+ M[m]+periodo+ FCST)
		rmsd_v = np.ma.load( path_in + 'rmsd_v_' + temp + '_M'+ M[m]+periodo+ FCST)
		rmsd_t = np.ma.load( path_in + 'rmsd_t_' + temp + '_M'+ M[m]+periodo+ FCST)
		rmsd_q = np.ma.load( path_in + 'rmsd_q_' + temp + '_M'+ M[m]+periodo+ FCST)

	else:
		rmsd_geo = np.ma.load( path_in + M[m] + '/rmsd_geo_' + temp + '_M'+ M[m]+periodo+ FCST )
		rmsd_u = np.ma.load( path_in + M[m] + '/rmsd_u_' + temp + '_M'+ M[m]+periodo+ FCST)
		rmsd_v = np.ma.load( path_in + M[m] + '/rmsd_v_' + temp + '_M'+ M[m]+periodo+ FCST)
		rmsd_t = np.ma.load( path_in + M[m] + '/rmsd_t_' + temp + '_M'+ M[m]+periodo+ FCST)
		rmsd_q = np.ma.load( path_in + M[m] + '/rmsd_q_' + temp + '_M'+ M[m]+periodo+ FCST)
	...
	if exp=='/GFS':
		np.ma.dump(rmsd_geo_vert, path_out + '/rmsd_geo_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_u_vert, path_out + '/rmsd_u_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_v_vert, path_out + '/rmsd_v_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_t_vert, path_out + '/rmsd_t_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_q_vert, path_out + '/rmsd_q_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
	else:
		np.ma.dump(rmsd_geo_vert, path_out + '/'  + M[m] + '/rmsd_geo_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_u_vert, path_out + '/'  + M[m] + '/rmsd_u_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_v_vert, path_out + '/'  + M[m] + '/rmsd_v_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_t_vert, path_out + '/'  + M[m] + '/rmsd_t_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_q_vert, path_out + '/'  + M[m] + '/rmsd_q_vert_' + temp + '_M'+ M[m] +periodo+ FCST)
