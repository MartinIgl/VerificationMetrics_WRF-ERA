...
#contador = -1  #sirve para generar un array de los promedios todos juntos
...
#dominio de grafico
	...
	while d <= diafin:
		...
		eeth = np.ma.load( path_in +'/' + M[m] + '/EETH_' + YY + MM + DD + HH + '_ana' + ANA )
	...
	#np.ma.dump(M_EETH_T_recortado, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_temporal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_EETH_H_recortado, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_horizontal_recortado' + '_ana' + ANA )
	#np.ma.dump(M_EETH_V_recortado, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_vertical_recortado' + '_ana' + ANA)
 
	#dominio entero
	np.ma.dump(M_EETH_T, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_temporal' +periodo+ '_ana' + ANA )
	np.ma.dump(M_EETH_H, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_horizontal' +periodo+ '_ana' + ANA )
	np.ma.dump(M_EETH_V, path_out +'/meantot'+ '/' + M[m] + '/M_EETH_vertical' +periodo+ '_ana' + ANA )
