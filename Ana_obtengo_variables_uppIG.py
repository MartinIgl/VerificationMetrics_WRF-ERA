...
if EXP == 'connud':
	path_upp = '/data/miglesias/asim_nud/ANA'
	path_salida = '/data/miglesias/verificacion_doc/variables_WRF_UPP_interpoladas'
elif EXP == 'sinnud':
	path_upp = '/data/miglesias/asim_snud/ANA'
	path_salida = '/data/miglesias/verificacion_doc/variables_WRF_UPP_interpoladas_sinnud'
elif EXP == 'spnud6h':
	path_upp = '/data/miglesias/asim_nud6h/ANA'
	path_salida = '/data/miglesias/verificacion_doc/variables_WRF_UPP_interpoladas_spnud6h'
elif EXP == 'spnud6hUV':
	path_upp = '/data/miglesias/asim_nud_uv6h/ANA'
	path_salida = '/data/miglesias/verificacion_doc/variables_WRF_UPP_interpoladas_SPnudUV6h'
...
#       2015120100/MEM/wrfprs01_20151201_00.012 -> datos de 2015120112 	
		...
		arch_WRF01 = path_upp + '/' + Ywrf + '-' + Mwrf + '-' + Dwrf + '_' + Hwrf + '_00_00' + '/ana01' +  M[m] + '_' + Ywrf + Mwrf + Dwrf + '_' + Hwrf + ANA

		arch_WRF02 = path_upp + '/' + Ywrf + '-' + Mwrf + '-' + Dwrf + '_' + Hwrf + '_00_00' + '/ana02' +  M[m] + '_' + Ywrf + Mwrf + Dwrf + '_' + Hwrf + ANA	
		...
		np.ma.dump(geopt[:,190:300,519:679], path_salida + '/' + M[m] + '/geopt_upp_' + Yfcst + Mfcst + Dfcst + Hfcst + '_ana'+ ANA)
		# Libero memoria:
		geopt = 0
		geopt_up = 0
		geopt_rav = 0
		...
		np.ma.dump(tk[:,190:300,519:679], path_salida + '/' + M[m] + '/tk_upp_' + Yfcst + Mfcst + Dfcst + Hfcst + '_ana'+ ANA)
		tk = 0
		tk_up = 0
		tk_rav = 0
		tk_upp = 0
		...
		np.ma.dump(q[:,190:300,519:679], path_salida + '/' + M[m] + '/q_upp_' + Yfcst + Mfcst + Dfcst + Hfcst + '_ana'+ ANA)
		q = 0
		q_up = 0
		q_rav = 0
		q_upp = 0
		...
		np.ma.dump(u[:,190:300,519:679], path_salida + '/' + M[m] + '/u_upp_' + Yfcst + Mfcst + Dfcst + Hfcst + '_ana'+ ANA)
		u = 0
		u_up = 0
		urot_rav = 0
		urot = 0
		...
		np.ma.dump(v[:,190:300,519:679], path_salida + '/' + M[m] + '/v_upp_' + Yfcst + Mfcst + Dfcst + Hfcst + '_ana'+ ANA)
		v = 0
                v_up = 0
                vrot_rav = 0
                vrot = 0
		...
		np.ma.dump(psfc[190:300,519:679], path_salida + '/' + M[m] + '/psfc_upp_' + Yfcst + Mfcst + Dfcst + Hfcst + '_ana'+ ANA)
		psfc = 0
