...
if EXP == 'GFS':
	...
	path_out = '/data/miglesias/verificacion_doc/dif_ERA_GEFS/ErrorEnergiaTotalHumeda' + exp + '/meantot'
else:
	quit()
...
while d <= diafin:
	...
	eeth = np.ma.load( path_in + '/EETH_GFS_' + YY + MM + DD + HH + FCST)
...
#np.ma.dump(M_EETH_T_recortado, path_out +'/meantot' + '/M_EETH_temporal_recortado' + FCST)
#np.ma.dump(M_EETH_H_recortado, path_out +'/meantot' + '/M_EETH_horizontal_recortado' + FCST)
#np.ma.dump(M_EETH_V_recortado, path_out +'/meantot' + '/M_EETH_vertical_recortado' + FCST)

#dominio entero
np.ma.dump(M_EETH_T, path_out + '/M_EETH_temporal_'+periodo + FCST)
np.ma.dump(M_EETH_H, path_out + '/M_EETH_horizontal_'+periodo + FCST)
np.ma.dump(M_EETH_V, path_out + '/M_EETH_vertical_'+periodo + FCST)
