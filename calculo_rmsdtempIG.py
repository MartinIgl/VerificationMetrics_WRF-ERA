...
while m < len(M):
	...
	if exp == '/GFS':
		np.ma.dump(rmsd_geo, path_out + '/rmsd_geo_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_u, path_out + '/rmsd_u_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_v, path_out + '/rmsd_v_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_t, path_out + '/rmsd_t_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_q, path_out + '/rmsd_q_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_psfc, path_out + '/rmsd_psfc_'  + date + '_M'+ M[m] +periodo+ FCST)
	else:
		np.ma.dump(rmsd_geo, path_out + '/' + M[m] + '/rmsd_geo_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_u, path_out + '/' + M[m] + '/rmsd_u_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_v, path_out + '/' + M[m] + '/rmsd_v_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_t, path_out + '/' + M[m] + '/rmsd_t_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_q, path_out + '/' + M[m] + '/rmsd_q_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_psfc, path_out + '/' + M[m] + '/rmsd_psfc_'  + date + '_M'+ M[m] +periodo+ FCST)
	...
	if exp == '/GFS':
		np.ma.dump(rmsd_geotot, path_out + '/rmsd_geotot_' + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_utot, path_out + '/rmsd_utot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_vtot, path_out + '/rmsd_vtot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_ttot, path_out + '/rmsd_ttot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_qtot, path_out + '/rmsd_qtot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_psfctot, path_out + '/rmsd_psfctot_'  + date + '_M'+ M[m] +periodo+ FCST)
	else:
		np.ma.dump(rmsd_geotot, path_out + '/' + M[m] + '/rmsd_geotot_' + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_utot, path_out + '/' + M[m] + '/rmsd_utot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_vtot, path_out + '/' + M[m] + '/rmsd_vtot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_ttot, path_out + '/' + M[m] + '/rmsd_ttot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_qtot, path_out + '/' + M[m] + '/rmsd_qtot_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_psfctot, path_out + '/' + M[m] + '/rmsd_psfctot_'  + date + '_M'+ M[m] +periodo+ FCST)
...
#promedio total vertical y temporal cada delta t 
	...
	if exp == '/GFS':
		np.ma.dump(rmsd_geoH, path_out + '/rmsd_geoH_' + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_uH, path_out + '/rmsd_uH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_vH, path_out + '/rmsd_vH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_tH, path_out + '/rmsd_tH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_qH, path_out + '/rmsd_qH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_psfcH, path_out + '/rmsd_psfcH_'  + date + '_M'+ M[m] +periodo+ FCST)
	else:
		np.ma.dump(rmsd_geoH, path_out + '/' + M[m] + '/rmsd_geoH_' + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_uH, path_out + '/' + M[m] + '/rmsd_uH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_vH, path_out + '/' + M[m] + '/rmsd_vH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_tH, path_out + '/' + M[m] + '/rmsd_tH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_qH, path_out + '/' + M[m] + '/rmsd_qH_'  + date + '_M'+ M[m] +periodo+ FCST)
		np.ma.dump(rmsd_psfcH, path_out + '/' + M[m] + '/rmsd_psfcH_'  + date + '_M'+ M[m] +periodo+ FCST)
